...
Before=$(echo "$Out" | awk 'NR==5 {print $NF}')
# echo \"Before credential : $Before\"
...
Out=$(bash bash/db-data.sh --host=${mongo} --db=${db})
After=$(echo "$Out" | awk 'NR==5 {print $NF}')
# echo \"After credential : $After\"
...
echo \"New credential: $((After-Before))\"
echo \"TPS: $tps\"
`
		);
